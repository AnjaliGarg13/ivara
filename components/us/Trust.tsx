    ...
    <section className="py-24 bg-ivory" ref={ref}>
      <div className="container-ivara">
        ...
        >
          ...
          <h3 className="text-2xl font-bold mb-3">Designed for HIPAA Compliance</h3>
          <p className="text-white/80 max-w-xl mx-auto leading-relaxed">
            We are building Ivara with privacy as a foundation, not an afterthought.
            Your health data is yours, never sold, never shared without your explicit consent.
          </p>
          <div className="mt-6 inline-flex items-center gap-2 bg-white/10 rounded-full px-5 py-2 text-sm font-medium text-white/90">
            ...
            HIPAA compliance in progress · Launching 2026
          </div>
        </motion.div>
      </div>
    </section>
